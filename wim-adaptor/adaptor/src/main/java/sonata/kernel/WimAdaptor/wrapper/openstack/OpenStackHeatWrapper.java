...
import sonata.kernel.WimAdaptor.DeployServiceCallProcessor;
import sonata.kernel.WimAdaptor.commons.DeployServiceData;
import sonata.kernel.WimAdaptor.commons.heat.HeatModel;
...
import sonata.kernel.WimAdaptor.commons.nsd.NetworkFunction;
import sonata.kernel.WimAdaptor.commons.nsd.ServiceDescriptor;
import sonata.kernel.WimAdaptor.commons.nsd.VirtualLink;
...
import sonata.kernel.WimAdaptor.commons.vnfd.VnfVirtualLink;
import sonata.kernel.WimAdaptor.wrapper.ComputeWrapper;
...
public class OpenStackHeatWrapper extends ComputeWrapper {
  ...
  public boolean deployService(DeployServiceData data,
    ...
    OpenStackHeatClient client = new OpenStackHeatClient(config.getWimEndpoint().toString(),
