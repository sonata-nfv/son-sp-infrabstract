...
import sonata.kernel.WimAdaptor.commons.ResourceAvailabilityData;
...
import sonata.kernel.WimAdaptor.wrapper.openstack.OpenStackHeatClient;
...
public class DeployServiceTest extends TestCase implements MessageReceiver {
  ...
  public void testCheckResources() throws IOException, InterruptedException {
    ...
    WimAdaptorCore core = new WimAdaptorCore(muxQueue, dispatcherQueue, consumer, producer, 0.1);
